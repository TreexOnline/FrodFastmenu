-- Script corrigido para resolver ambiguidade de coluna
-- Usando aliases para evitar conflito entre variáveis PL/pgSQL e colunas
...
BEGIN
    ...
    FOR tbl_name IN 
        ...
        AND t.table_name IN ('categories', 'menu_items', 'orders', 'stores', 'profiles', 'whatsapp_auto_messages')
    LOOP
        ...
        LOOP
            tbl_columns := tbl_columns || col_name || ', ';
        END LOOP;
        
        RAISE NOTICE 'Colunas: %', tbl_columns;
    END LOOP;
